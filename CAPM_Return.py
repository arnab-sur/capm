...
with col1:
    stocks_list = st.multiselect("Choose stocks", ('TSLA','AAPL','NFLX','MSFT','MGM','AMZN','NVDA','GOOGL','AMCR','AMD','CME','EBAY','JPM','SLB','SNPS','WMT'),['TSLA','AAPL','AMZN','GOOGL'])
with col2:
...
try:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown('### '+str(year)+' Year Before')
